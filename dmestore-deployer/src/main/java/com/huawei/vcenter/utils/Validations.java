...
public class Validations {
    ...
    public static Map onSubmit(String packageUrl, String vcenterUsername, String vcenterPassword,
                               String vcenterIp, String vcenterPort, String version, String dmeip, String dmeport,
                               String dmeusername, String dmepassword) {
        ...
        ThreadPoolExecutor executor =
            new ThreadPoolExecutor(1, 2, 1000, TimeUnit.MILLISECONDS, new SynchronousQueue<Runnable>(),
    ...
    public static String vcenteraction(String vcenterIp, String vcenterUsername,
                                       ...
                                       String dmeIp, String dmePort, String dmeUsername, String dmePassword) {
        String result = null;
        try {
