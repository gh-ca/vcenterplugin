...
public class HostVmwareFactory {
     ...
     */
    public HostMoObj build(VmwareContext context, ManagedObjectReference morHost) throws Exception {
        return new HostMoObj(context, morHost);
    }
     ...
     * @throws Exception Exception
     */
    public HostMoObj build(VmwareContext context, String hostName) throws Exception {
        return new HostMoObj(context, hostName);
    }
}
