...
public class DME extends DMEbase implements Serializable {
	...
	public DME(String hostIp, int hostPort, String loginAccount, String loginPwd) {
    ...
    public String toString() {
        return "dme [id=" + id + ", hostIp=" + getHostIp() + ", hostPort=" + getHostPort() + ", loginAccount=" + getLoginAccount()
