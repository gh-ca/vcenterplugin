...
import com.dmeplugin.dmestore.services.SampleActionService;
...
public class ActionsController {
 ...
 /*  @Autowired
   ...
   public Map<String, Object> invoke(
      ...
      if (actionUid.equals("com.dmeplugin.dmestore.sampleAction1")) {
      ...
      } else if (actionUid.equals("com.dmeplugin.dmestore.sampleAction2")) {
