...
public class SqlFileConstant {
  ...
  public static final String[] ALL_TABLES = {SqlFileConstant.HW_ESIGHT_HOST,
      ...
      SqlFileConstant.HW_TASK_RESOURCE, SqlFileConstant.HW_ESIGHT_HA_SERVER,
      SqlFileConstant.HW_VCENTER_INFO, SqlFileConstant.HW_SERVER_DEVICE_DETAIL,
      SqlFileConstant.HW_ALARM_DEFINITION, SqlFileConstant.HW_HA_COMPONENT,
      SqlFileConstant.HW_ALARM_RECORD};
  ...
  public static final String HW_ESIGHT_THUMBPRINT_SQL =
      "DROP TABLE IF EXISTS \"HW_ESIGHT_THUMBPRINT\";\n"
  ...
  public static final String HW_ESIGHT_HA_SERVER_SQL =
  ...
  public static final String HW_SERVER_DEVICE_DETAIL_SQL =
  ...
  public static final String HW_ALARM_DEFINITION_SQL =
      "DROP TABLE IF EXISTS \"HW_ALARM_DEFINITION\";\n"
  ...
  public static final String HW_HA_COMPONENT_SQL = "CREATE TABLE \"HW_HA_COMPONENT\" (\n"
      + "  \"ID\"  integer PRIMARY KEY AUTO_INCREMENT NOT NULL,\n"
      + "  \"ESIGHT_HOST_ID\"  int,\n"
      + "  \"COMPONENT\"  nvarchar(32),\n"
      + "  \"DN\"  nvarchar(255),\n"
  ...
  public static final String HW_ALARM_RECORD_SQL = "CREATE TABLE \"HW_ALARM_RECORD\" (\n"
      + "  \"ID\"  integer PRIMARY KEY AUTO_INCREMENT NOT NULL,\n"
      + "  \"ESIGHT_HOST_ID\"  int,\n"
  ...
  public static final String HW_VCENTER_INFO_HOSTPORT = "HOST_PORT";
  ...
  public static final String HW_VCENTER_INFO_HOSTPORT_ALTER_SQL = "ALTER TABLE HW_VCENTER_INFO ADD HOST_PORT int default 443;";
  ...
  public static final String COLUMN_ESIGHT_SERVER_PARENT_DN_SQL =
      "ALTER TABLE " + HW_ESIGHT_HA_SERVER + " ADD " +
