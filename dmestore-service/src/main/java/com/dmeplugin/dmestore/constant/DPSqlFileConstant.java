 ...
 * DPSqlFileConstant.
 */
public final class DPSqlFileConstant {
    /**
     * DME访问信息表 .
     */
     ...
     * DME与VMWARE对应关系表 .
     */
    public static final String DP_DME_VMWARE_RELATION =
        "DP_DME_VMWARE_RELATION";
    /**
     * 存储关系表 .
     */
    ...
    public static final String[] ALL_TABLES = {
        DPSqlFileConstant.DP_DME_ACCESS_INFO,
        DPSqlFileConstant.DP_DME_VMWARE_RELATION,
        DPSqlFileConstant.DP_DME_TASK_INFO,
        DPSqlFileConstant.DP_DME_BEST_PRACTICE_CHECK,
        DPSqlFileConstant.DP_DME_VCENTER_INFO
    };
    /**
     * DP_DME_ACCESS_INFO_SQL .
     */
    public static final String DP_DME_ACCESS_INFO_SQL = "DROP TABLE IF EXISTS"
        + " \"DP_DME_ACCESS_INFO\";\n"
     ...
     */
    public static final String DP_DME_VMWARE_RELATION_SQL =
        "DROP TABLE IF EXISTS" + " \"DP_DME_VMWARE_RELATION\";\n"
     ...
     */
    public static final String DP_DME_TASK_INFO_SQL =
        "DROP TABLE IF EXISTS \"DP_DME_TASK_INFO\";\n"
    ...
    public static final String DP_DME_TASK_DATA_SYNCSERVICELEVEL_SQL =
        "INSERT INTO DP_DME_TASK_INFO (ID, CLASS_NAME, CRON, JOB_NAME, METHOD) "
            + "VALUES (1, "
    ...
    public static final String DP_DME_TASK_DATA_REFRESHRESOURCEINSTANCE_SQL =
        "INSERT INTO DP_DME_TASK_INFO (ID, CLASS_NAME, CRON, JOB_NAME, METHOD) "
            + "VALUES (4, "
            + "'com.dmeplugin.dmestore."
            + "task.BackGroundRefreshResourceInstanceTask',"
            + "'0 */1 * * * ?', 'refreshResourceInstance', "
            + "'refreshResourceInstance');";

    /**
     * DP_DME_BEST_PRACTICE_CHECK.
     */
    public static final String DP_DME_BEST_PRACTICE_CHECK =
        "DP_DME_BEST_PRACTICE_CHECK";
    /**
     * DP_DME_BEST_PRACTICE_CHECK_SQL.
     */
    public static final String DP_DME_BEST_PRACTICE_CHECK_SQL =
        "DROP TABLE IF EXISTS \"DP_DME_BEST_PRACTICE_CHECK\";\n"
     ...
     */
    public static final String DP_DME_BEST_PRACTICE_CHECK_ALTER_SQL
        = "ALTER TABLE DP_DME_BEST_PRACTICE_CHECK "
        + "ALTER COLUMN ACTUAL_VALUE CLOB;";
    /**
     * DP_DME_VCENTER_INFO_SQL.
     */
    public static final String DP_DME_VCENTER_INFO_SQL = "DROP TABLE IF EXISTS "
        + "\"DP_DME_VCENTER_INFO\";\n"
