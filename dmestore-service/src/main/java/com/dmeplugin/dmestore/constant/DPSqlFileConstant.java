...
public class DPSqlFileConstant {
    ...
    public static final String[] ALL_TABLES = {
        DPSqlFileConstant.DP_DME_ACCESS_INFO, DPSqlFileConstant.DP_DME_VMWARE_RELATION,
        DPSqlFileConstant.DP_DME_TASK_INFO, DPSqlFileConstant.DP_DME_BEST_PRACTICE_CHECK,
    ...
    public static final String DP_DME_BEST_PRACTICE_CHECK_ALTER_SQL
        = "ALTER TABLE DP_DME_BEST_PRACTICE_CHECK ALTER COLUMN ACTUAL_VALUE CLOB;";
