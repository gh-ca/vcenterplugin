...
public class VmfsOperationControllerTest {
    ...
    public void updateVmfs() throws Exception {
        String param = "{\n" +
                ...
                "    \"latencyChoose\": false\n" +
                "}";
        mockMvc.perform(MockMvcRequestBuilders.put("/operatevmfs/updatevmfs").contentType(MediaType.APPLICATION_JSON).content(param)
                .param("volumeId", "d6a20f27-fe4c-4a40-ac28-529aad1a7550")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void recycleVmfsByDatastoreIds() throws Exception {
        String param = "[\"Dvmfs999\"]";
        mockMvc.perform(MockMvcRequestBuilders.post("/operatevmfs/recyclevmfsbydatastoreids").contentType(MediaType.APPLICATION_JSON)
                .content(param)).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void listServiceLevelVmfs() throws Exception {
        String param = "{\n" +
                ...
                "    \"obj_id\": \"urn:vmomi:Datastore:datastore-1233:674908e5-ab21-4079-9cb1-596358ee5dd1\"\n" +
                "}";
        mockMvc.perform(MockMvcRequestBuilders.put("/operatevmfs/listvmfsservicelevel").contentType(MediaType.APPLICATION_JSON).content(param)).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void updateServiceLevelVmfs() throws Exception {
        String param = "{\n" +
                ...
                "    \"obj_id\": \"urn:vmomi:Datastore:datastore-1233:674908e5-ab21-4079-9cb1-596358ee5dd1\"\n" +
                "}";
        mockMvc.perform(MockMvcRequestBuilders.post("/operatevmfs/updatevmfsservicelevel").contentType(MediaType.APPLICATION_JSON).content(param)).andExpect(MockMvcResultMatchers.status().isOk());
    }
}