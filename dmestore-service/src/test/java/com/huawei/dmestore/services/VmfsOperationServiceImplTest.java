...
public class VmfsOperationServiceImplTest {
    ...
    @Test
    public void testUpdateVmfs() throws DmeException {
        String param = "{\n" +
                "    \"name\": \"Dvmfs999\", \n" +
                "    \"isSameName\": true, \n" +
    ...
    @Test
    public void testExpandVmfs() throws DmeException {
        String param = "{\n" +
                "    \"vo_add_capacity\": \"2\", \n" +
                "    \"capacityUnit\": \"GB\", \n" +
    ...
    @Test
    public void testRecycleVmfsCapacityByDataStoreIds() throws DmeException {
        List<String> list = new ArrayList<>();
        list.add("Dvmfs999");
        when(vcsdkUtils.getDataStoreName(anyString())).thenReturn("success");
        when(vcsdkUtils.recycleVmfsCapacity(anyString())).thenReturn("success");
        vmfsOperationService.recycleVmfsCapacityByDataStoreIds(list);

    }

    @Test
    public void testUpdateVmfsServiceLevel() throws DmeException {
        String param = "{\n" +
                "    \"vo_add_capacity\": 2, \n" +
                "    \"capacityUnit\": \"GB\", \n" +
                "    \"volume_id\": \"d6a20f27-fe4c-4a40-ac28-529aad1a7550\", \n" +
    ...
    @Test
    public void testListServiceLevelVmfs() throws DmeException {
