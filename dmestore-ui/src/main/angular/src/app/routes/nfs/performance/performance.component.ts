...
@Component({
  ...
  providers: [PerformanceService, MakePerformance, NfsService,NgxEchartsModule],
})
export class NfsPerformanceComponent implements OnInit, AfterViewInit {
  ...
  // 卷ID
  constructor(private makePerformance: MakePerformance, private perService: PerformanceService, private ngZone: NgZone, private cdr: ChangeDetectorRef) {
  }
