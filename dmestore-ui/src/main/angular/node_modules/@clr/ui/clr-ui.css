...
:root {
  ...
  --clr-combobox-input-background: #f4f5f6;
  --clr-combobox-pill-background-color: #e8f5fc;
  --clr-combobox-pill-border-color: #b4d7e9;
  --clr-combobox-pill-font-color: black;
  --clr-combobox-filter-highlight: #575757;
}
...
.clr-combobox-wrapper {
  ...
  background-color: var(--clr-combobox-input-background-color, #f4f5f6);
}
...
.clr-combobox-wrapper .label-combobox-pill {
  ...
  background-color: var(--clr-combobox-pill-background-color, #e8f5fc);
  border-width: 0.05rem;
  border-style: solid;
  /* clr-combobox-pill-border-color */
  border-color: #b4d7e9;
  border-color: var(--clr-combobox-pill-border-color, #b4d7e9);
  padding: 0 0.2rem;
}
.clr-combobox-wrapper .label-combobox-pill .clr-combobox-pill-content {
  /* clr-combobox-pill-font-color */
  color: black;
  color: var(--clr-combobox-pill-font-color, black);
  font-size: 0.55rem;
  font-weight: 400;
...
.clr-combobox-trigger {
  ...
  color: #b3b3b3;
  color: var(--clr-combobox-trigger-color, #b3b3b3);
  cursor: pointer;
  outline: none;
}
...
.clr-filter-highlight b {
  ...
  color: #575757;
  color: var(--clr-combobox-filter-highlight, #575757);
}
