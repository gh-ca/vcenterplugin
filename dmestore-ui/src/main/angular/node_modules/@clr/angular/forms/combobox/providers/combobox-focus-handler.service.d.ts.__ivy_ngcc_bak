...
export declare class ComboboxFocusHandler<T> {
    ...
    private appRef;
    private platformId;
    constructor(id: string, rendererFactory: RendererFactory2, toggleService: ClrPopoverToggleService, selectionService: OptionSelectionService<T>, appRef: ApplicationRef, platformId: any);
    private renderer;
...
export declare const COMBOBOX_FOCUS_HANDLER_PROVIDER: ({
    ...
    provide: typeof import("../../../clr-angular").ɵq;
