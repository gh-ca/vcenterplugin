...
export declare class BasicFocusableItem implements FocusableItem {
    ...
    private renderer;
    private platformId;
    constructor(id: string, el: ElementRef<HTMLElement>, renderer: Renderer2, platformId: any);
    disabled: boolean;
    focus(): void;
    blur(): void;
    activate(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<BasicFocusableItem, never>;
...
//# sourceMappingURL=basic-focusable-item.service.d.ts.map