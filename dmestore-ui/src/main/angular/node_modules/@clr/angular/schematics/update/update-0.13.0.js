...
---------------------------`);
        ...
        function getNewClassname(oldClassname) {
            switch (oldClassname) {
                case 'Comparator':
            ...
            if (dir.subfiles.length) {
                dir.subfiles.forEach(file => {
                    ...
                    if (updated.search(/shape=['"](angle-double|bar-chart|collapse|line-chart|wand)['"]/g) > -1) {
                        logMessage('info', 'INFO: The following icons have been deprecated in its respective set and have been moved to another set: \n`angle-double`, `bar-chart`, `collapse`, `line-chart`, `wand`\nPlease check that they are being imported from the correct set.', filePath, '0.13.0-rc.1');
                    }
                    if (content !== updated) {
